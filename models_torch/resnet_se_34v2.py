...
from .resnet_blocks import SEBasicBlock
...
class ResNetSE34V2(nn.Module):
    def __init__(self,
        ...
        self.layer2 = self._make_layer(SEBasicBlock,
                                       num_filters[1],
                                       layers[1],
                                       stride=(2, 2))
        self.layer3 = self._make_layer(SEBasicBlock,
                                       num_filters[2],
                                       layers[2],
                                       stride=(2, 2))
        self.layer4 = self._make_layer(SEBasicBlock,
                                       num_filters[3],
                                       layers[3],
                                       stride=(2, 2))
